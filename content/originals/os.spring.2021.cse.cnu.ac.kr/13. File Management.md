...
![스크린샷 2021-06-13 오후 4.14.29.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image1.png)
...
![스크린샷 2021-06-13 오후 4.42.11.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image2.png)
...
![스크린샷 2021-06-13 오후 4.48.06.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image3.png)
...
![스크린샷 2021-06-13 오후 5.12.17.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image4.png)
...
![스크린샷 2021-06-13 오후 5.13.16.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image5.png)

- *Tree Structured Directory* : 일반적으로 우리가 생각하는 디렉토리의 구조 여러명의 유저가 있고 한 유저 안에서도 여러개의 디렉토리, 디렉토리 안의 디렉토리를 생성해 트리구조로 디렉토리들이 형성되는 것

![스크린샷 2021-06-13 오후 5.15.15.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image6.png)

- *Acyclic Graph Directory* : 얘도 동일하게 트리구조를 갖지만 트리구조에서는 할 수 없는 공유의 개념이 가능한 구조이다 - 파일 하나를 여러명의 유저가 공유할 수 있는 구조

![스크린샷 2021-06-13 오후 5.17.32.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image7.png)

### File Sharing System

![스크린샷 2021-06-13 오후 5.22.33.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image8.png)
...
![스크린샷 2021-06-13 오후 6.00.47.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image9.png)
...
![스크린샷 2021-06-13 오후 6.06.29.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image10.png)
...
![스크린샷 2021-06-13 오후 6.11.02.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image11.png)
...
![스크린샷 2021-06-13 오후 6.22.19.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image12.png)
...
![스크린샷 2021-06-13 오후 6.26.18.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image13.png)

- *Bit Table*은 모든 Block# 에 하나씩 비트를 할당한 테이블로 이 비트를 이용해 해당 블럭이 비었는지 아닌지를 표시하는 방법이다

### Chained Free Portions

![스크린샷 2021-06-13 오후 6.28.00.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image14.png)

- *Chained Free Portions*는 Free block들을 Linked List처럼 이어놓은 형태이다

### Indexing

![스크린샷 2021-06-13 오후 6.29.20.png](originals/os.spring.2021.cse.cnu.ac.kr/images/13/image15.png)
