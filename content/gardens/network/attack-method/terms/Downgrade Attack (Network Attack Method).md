...
- 그런데 [[Transport Layer Security, TLS (L6 Presentation Layer)|TLS]] 와 같이 version negotiation 이 있는 프로토콜의 경우에는 MITM 이 악의적으로 프로토콜 버전을 낮춰 알려진 취약점을 활용할 수 있다.
...
- 아니면 [[Transport Layer Security, TLS (L6 Presentation Layer)|Finished 과정]] 을 활용하여 검사할 수도 있다.
