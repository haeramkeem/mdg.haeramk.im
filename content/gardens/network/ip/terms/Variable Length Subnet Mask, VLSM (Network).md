...
- 그래서 *Variable Length Subnet Mask* (*VLSM*) 은 어떻게 Classful 한 방식을 보완하냐면:
...
- 즉, 네트워크의 서브넷을 나눌 때 서브넷 마스크의 길이가 Class 에 따라서 결정되는 고정길이가 아니고 가변길이를 사용해서 불필요한 IP 의 낭비를 막는다는 개념이다.