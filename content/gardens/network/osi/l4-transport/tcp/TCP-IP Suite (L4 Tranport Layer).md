...
- *Internet Layer*: L3 정도로 비유되며, WAN 에서의 라우팅에 관여한다
    - 당연히 [[Internet Protocol, IP (L3 Network Layer)|IP]] 주소를 사용한다.
- *Transport Layer*: L4 정도로 비유되며, End-to-end reliability ([[Transmission Control Protocol, TCP (L4 Tranport Layer)|TCP]]) 와 Process-to-process 를 담당한다.
    - 당연히 Port 를 사용한다.
