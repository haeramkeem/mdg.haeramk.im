...
- [[Domain Name System, DNS (Network)|DNS]] 에서 [[Resolver (DNS)|resolver]] 의 작동 과정을 보면 authentication 에 대한 고려가 전혀 없다는 것을 알 수 있다.
...
- DNSSEC 에서는 기존의 [[Domain Name System, DNS (Network)|DNS header]] 에 다음과 같은 Flag 가 추가된다.
