...
## 추가 문제) 모든 경로 중 짧은 경로길이 찾기

> [!tip] 이론수업 중 제시된 문제로 추정됨

> [!info]- 문제
> - 출발 노드에서 중간 노드를 모두 방문하고 목적지노드로 돌아오는 이동 경로 중 가장 짧은 경로의 길이를 출력하시오.
> - 두 노드: (x1, y1) (x2, y2)
 > - 두 노드 사이 거리 = |x1 – x2| +|x2 - y2|
> - 노드 개수: 2개에서 10개 사이
> - 입력 예시
> ```
> 1 # test case
> 3 # 노드 개수
> 0 0 1 1 2 2 3 3 # (0,0): 출발지, (1,1): 목적지, 이후 중간 노드
> ```
