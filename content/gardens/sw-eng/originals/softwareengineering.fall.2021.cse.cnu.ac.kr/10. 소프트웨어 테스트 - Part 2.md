...
- 이때 중요한건 total stmt에서 unreachable stmt의 갯수를 빼줘야 된다는 거다 - unreachable stmt를 빼지 않으면 절대로 100퍼가 나오지 않으므로 - 따라서 unreachable stmt를 coverage를 구하기 전에 반드시 구해줘야 한다기

### Decision Testing & Coverage

> [!success] 작물 심어짐
> - [[Decision Coverage (SW  Testing)]]
...
> [!success] 작물 심어짐
> - [[Multiple Condition Coverage (SW  Testing)]]
