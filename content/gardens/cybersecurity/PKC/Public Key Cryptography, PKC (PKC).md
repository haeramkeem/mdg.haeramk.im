...
> [!tip]- 새벽 세시에 햄버거를 먹는 놈이 있다고?
> ![[Pasted image 20240603133939.png]]

- 인생은 실전이다. 알베르 까뮈가 말한 '참으로 진지한, 그리고 오직 하나뿐인 철학적 문제' 는 '새벽 세시에 햄버거를 맛있게 먹는 방법' 이다. [[index|동작구 김씨]] 는 송파구 사는 서씨에게 이 방법에 대해 암호화해서 은밀하게 알려준다고 해보자.
- 이때 서씨는 자신의 공개키를 김씨한테 알려준다.
	- 공개키는 공개되어도 상관 없기 때문에, 그냥 줘도 된다.
- 그럼 김씨는 이 공개키를 이용해 적어둔 "새벽 세시에 햄버거를 맛있게 먹는 방법" 을 암호화해서 서씨에게 보낸다.
	- 어차피 이것은 암호화되어 있기 때문에, 중간에 강남구 사는 오씨가 훔친다고 해도 "김씨의 특허받은 새벽 세시에 햄버거를 맛있게 먹는 방법" 을 알아낼 수는 없다.
