...
- 태그의 draggable 속성이 true로 되어있어야 함 `<tag draggable="true">`
- ongradstart 속성에 드래그를 시작할때 호출할 함수를 입력하여 드래그하려는 놈의 id를 Event.dataTransfer에 저장함
...
- 드롭되었을때 ondrop event가 발생하고 이때 Event.dataTransfer에 저장한 정보를 갖고옴
