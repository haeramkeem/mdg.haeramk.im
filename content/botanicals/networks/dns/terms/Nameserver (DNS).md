...
- 자기 자신에는 많은 정보를 저장하지 않고, 다른 DNS nameserver 들로 query 를 forward 해 IP 를 받아와 host 들에게 응답하고 (이 부분은 [[How DNS Works - Recursive or Iterative (DNS)|이 문서]] 에서 좀 더 자세히 알아보자)
